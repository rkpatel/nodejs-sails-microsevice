/***************************************************************************
  ...
  Model          			: scenario_job_type
  Database Table      : scenario_job_type

  *************************
  Column      :   type
  scenario_job_type_id : number
  scenario_id : number
  job_type_id : number
  status : string
  created_by :number
...
module.exports = {
  tableName  : 'scenario_job_type',
  primaryKey : 'scenario_job_type_id',
  attributes : {
    scenario_job_type_id : { type: 'number', autoIncrement: true },
