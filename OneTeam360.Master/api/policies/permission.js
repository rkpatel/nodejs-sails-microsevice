...
module.exports = async (req, res, next) => {
  ...
  sails.log('permissionCodesRequiredForApi',permissionCodesRequiredForApi);
  if(req.permissions && req.permissions.length){
    if(permissionCodesRequiredForApi && permissionCodesRequiredForApi.and){
      ...
      sails.log('filterperm',filterperm,permissions);
    ...
    if(permissionCodesRequiredForApi && permissionCodesRequiredForApi.or){
      ...
      sails.log('filterperm',messages.ROLE_PERMISSION_REQUIRED);
      await filterPermData(filterperm,res);
    }
    next();
  }else{
    sails.log('else',req.permissions);
    errorData(req,res);
  }
};
