...
module.exports = {
  ...
  attributes : {
    ...
    user_id             : { type: 'number' },
    role_id             : { model: 'Role' },
    date_of_joining     : { required: true, type: 'ref', columnType: 'date' },
    points              : { type: 'number', columnType: 'double' },
    status              : { type: 'string', isIn: ['Inactive', 'Active'] },
    level_id            : { model: 'Level' },
    employee_import_id  : { type: 'number' },
    ...
    certificate         : { collection: 'CertificateType', via: 'employee_profile_id', through: 'EmpCertification' },
    ...
    team_member_id      : { type: 'string', allowNull: true },
  },
