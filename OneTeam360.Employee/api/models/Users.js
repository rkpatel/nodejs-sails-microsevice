/***************************************************************************
  ...
  *************************
  ...
  emergency_contact_statecode :   string
...
module.exports = {
  ...
  attributes : {
    ...
    emergency_contact_city_id     : { model: 'city' },
    emergency_contact_state_id    : { model: 'state' },
    emergency_contact_country_id  : { model: 'country' },
